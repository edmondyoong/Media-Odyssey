...
public class User implements UserDetails {
    ...
    * This will be valuable for he header (goes to every thymeleaf page) + userProfile.
    ...
    */
    public User(String email, String password) {
        ...
        /* For new user, the selected_avatar (type) would always be default, until they decide to change it */
    ...
    public User(String email, String username, String password, boolean isEnabled, boolean isAccountNonLocked,
            String role, String default_avatar_URL, String custom_avatar_URL, String selected_avatar_type) {
        this.email = email;
